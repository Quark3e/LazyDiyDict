...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<bool>           values) {
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<int>            values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<float>          values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<double>         values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<char>           values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::string>    values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::vector<bool>>           values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::vector<int>>            values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::vector<float>>          values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::vector<double>>         values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::vector<char>>           values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::vector<std::string>>    values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::vector<std::vector<bool>>>           values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::vector<std::vector<int>>>            values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::vector<std::vector<float>>>          values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::vector<std::vector<double>>>         values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::vector<std::vector<char>>>           values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
...
LazyDiyDict::dict::dict(std::vector<std::string> keys, std::vector<std::vector<std::vector<std::string>>>    values) {
    //dict "storage" container constructor
    if(keys.size()!=values.size()) {
        throw std::runtime_error("ERROR:"+this->_info_name+"::dict(std::vector<std::string>, std::vector<T>) `keys` and `values` constructor args are not same size.");
    }
 ...
 */
int LazyDiyDict::dict::_extend_reg(std::string key, int varType) {
...
int LazyDiyDict::dict::_erase_idx(int typeID, int idx) {
...
std::string LazyDiyDict::dict::_bool_string(bool boolVar) {
 ...
 */
std::string LazyDiyDict::dict::str_export(
    std::string key,
    ...
    case 0: //bool
        ...
        break;
    case 1: //int
        if(vecType==0 && isPtr) tempStr = std::string(padding,emptySpace) + LazyDiyDict::formatNumber<int>(*values_0_int_p[pos],width,decimals,align) + std::string(padding,emptySpace);
        if(vecType==0 && !isPtr)tempStr = std::string(padding,emptySpace) + LazyDiyDict::formatNumber<int>(values_0_int[pos],width,decimals,align) + std::string(padding,emptySpace);
        ...
        break;
    case 2: //float
        if(vecType==0 && isPtr) tempStr = std::string(padding,emptySpace) + LazyDiyDict::formatNumber<float>(*values_0_float_p[pos],width,decimals,align) + std::string(padding,emptySpace);
        if(vecType==0 && !isPtr)tempStr = std::string(padding,emptySpace) + LazyDiyDict::formatNumber<float>(values_0_float[pos],width,decimals,align) + std::string(padding,emptySpace);
        ...
        break;
    case 3: //double
        if(vecType==0 && isPtr) tempStr = std::string(padding,emptySpace) + LazyDiyDict::formatNumber<double>(*values_0_double_p[pos],width,decimals,align) + std::string(padding,emptySpace);
        if(vecType==0 && !isPtr)tempStr = std::string(padding,emptySpace) + LazyDiyDict::formatNumber<double>(values_0_double[pos],width,decimals,align) + std::string(padding,emptySpace);
        ...
        break;
    case 4: //char
        if(vecType==0 && isPtr) tempStr = std::string(padding,emptySpace) + LazyDiyDict::formatNumber<char>(*values_0_char_p[pos],width,decimals,align) + std::string(padding,emptySpace);
        if(vecType==0 && !isPtr)tempStr = std::string(padding,emptySpace) + LazyDiyDict::formatNumber<char>(values_0_char[pos],width,decimals,align) + std::string(padding,emptySpace);
        ...
        break;
    case 5: //std::string
        if(vecType==0 && isPtr) tempStr = std::string(padding,emptySpace) + LazyDiyDict::formatNumber<std::string>(*values_0_string_p[pos],width,decimals,align) + std::string(padding,emptySpace);
        if(vecType==0 && !isPtr)tempStr = std::string(padding,emptySpace) + LazyDiyDict::formatNumber<std::string>(values_0_string[pos],width,decimals,align) + std::string(padding,emptySpace);
...
/// @brief get the this->_datatype code of `key` defined by `LazyDiyDict::dict::info_type_definition`
...
int LazyDiyDict::dict::get_type(std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
 ...
 */
int LazyDiyDict::dict::get_type_size(int typeID) {
    int vecSize = 0;
    if(typeID<this->typeLIM[0] || typeID>this->typeLIM[1]) return -1;
 ...
 */
int LazyDiyDict::dict::get_type_size(std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
 ...
 */
int LazyDiyDict::dict::rename_key(std::string key, std::string new_key) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
 ...
 */
int LazyDiyDict::dict::delete_key(std::string key) {
    /**
    ...
    if(pos==-1) return 1; // Key doesn't exist, meaning nothing to delete.
    ...
    std::vector<int> typeOcc{-1}; // = DIY_SEARCH_MULTITHREAD::multithread_searchVec<int>(this->_datatype, typeID, 1, -1, true);
    for(size_t i=0; i<this->_datatype.size(); i++) {
        if(this->_datatype.at(i)==typeID) typeOcc.push_back(i);
    }
    if(typeOcc.size()==0) return 1;
...
int LazyDiyDict::dict::edit(std::string key, bool value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
    if(type!=  0) return 1;
...
int LazyDiyDict::dict::edit(std::string key, int value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
    if(type!= 10) return 1;
...
int LazyDiyDict::dict::edit(std::string key, float value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
    if(type!= 20) return 1;
...
int LazyDiyDict::dict::edit(std::string key, double value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
    if(type!= 30) return 1;
...
int LazyDiyDict::dict::edit(std::string key, char value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
    if(type!= 40) return 1;
...
int LazyDiyDict::dict::edit(std::string key, std::string value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
    if(type!= 50) return 1;
...
int LazyDiyDict::dict::edit(std::string key, bool* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
    if(type!=  1) return 1;
...
int LazyDiyDict::dict::edit(std::string key, int* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
    if(type!= 11) return 1;
...
int LazyDiyDict::dict::edit(std::string key, float* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
    if(type!= 21) return 1;
...
int LazyDiyDict::dict::edit(std::string key, double* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
    if(type!= 31) return 1;
...
int LazyDiyDict::dict::edit(std::string key, char* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
    if(type!= 41) return 1;
...
int LazyDiyDict::dict::edit(std::string key, std::string* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
    if(type!= 51) return 1;
...
int LazyDiyDict::dict::edit(std::string key, std::vector<bool> value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<int> value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<float> value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<double> value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<char> value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::string> value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<bool>* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<int>* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<float>* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<double>* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<char>* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::string>* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::vector<bool>> value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::vector<int>> value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::vector<float>> value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::vector<double>> value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::vector<char>> value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::vector<std::string>> value) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::vector<bool>>* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::vector<int>>* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::vector<float>>* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::vector<double>>* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::vector<char>>* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
int LazyDiyDict::dict::edit(std::string key, std::vector<std::vector<std::string>>* ptr) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos==-1) return 1;
    int type = this->_datatype[pos];
...
std::vector<std::vector<bool>>        LazyDiyDict::dict::get2_bool_  (std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos!=-1 && this->_datatype[pos]==200) return values_2_bool.at(this->_idx[pos]);
    return std::vector<std::vector<bool>>();
}
std::vector<std::vector<int>>         LazyDiyDict::dict::get2_int_   (std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos!=-1 && this->_datatype[pos]==210) return values_2_int.at(this->_idx[pos]);
    return std::vector<std::vector<int>>();
}
std::vector<std::vector<float>>       LazyDiyDict::dict::get2_float_ (std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos!=-1 && this->_datatype[pos]==220) return values_2_float.at(this->_idx[pos]);
    return std::vector<std::vector<float>>();
}
std::vector<std::vector<double>>      LazyDiyDict::dict::get2_double_(std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos!=-1 && this->_datatype[pos]==230) return values_2_double.at(this->_idx[pos]);
    return std::vector<std::vector<double>>();
}
std::vector<std::vector<char>>        LazyDiyDict::dict::get2_char_  (std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos!=-1 && this->_datatype[pos]==240) return values_2_char.at(this->_idx[pos]);
    return std::vector<std::vector<char>>();
}
std::vector<std::vector<std::string>> LazyDiyDict::dict::get2_string_(std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos!=-1 && this->_datatype[pos]==250) return values_2_string.at(this->_idx[pos]);
    return std::vector<std::vector<std::string>>();
}

std::vector<std::vector<bool>>*        LazyDiyDict::dict::get2_boolP  (std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos!=-1 && this->_datatype[pos]==201) return values_2_bool_p.at(this->_idx[pos]);
    return nullptr;
}
std::vector<std::vector<int>>*         LazyDiyDict::dict::get2_intP   (std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos!=-1 && this->_datatype[pos]==211) return values_2_int_p.at(this->_idx[pos]);
    return nullptr;
}
std::vector<std::vector<float>>*       LazyDiyDict::dict::get2_floatP (std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos!=-1 && this->_datatype[pos]==221) return values_2_float_p.at(this->_idx[pos]);
    return nullptr;
}
std::vector<std::vector<double>>*      LazyDiyDict::dict::get2_doubleP(std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos!=-1 && this->_datatype[pos]==231) return values_2_double_p.at(this->_idx[pos]);
    return nullptr;
}
std::vector<std::vector<char>>*        LazyDiyDict::dict::get2_charP  (std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
    if(pos!=-1 && this->_datatype[pos]==241) return values_2_char_p.at(this->_idx[pos]);
    return nullptr;
}
std::vector<std::vector<std::string>>* LazyDiyDict::dict::get2_stringP(std::string key) {
    int pos = check_existence<std::string>(key, this->_keys);
